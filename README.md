...
-----
Antes de empezar con el diseño hicimos un [moodboard](https://github.com/Groctel/DIU21/tree/master/P3#moodboard-dise%C3%B1o-visual--logotipo) para encontrar la paleta de color y la inspiración para el logo.

![Método UX](img/landing-page.png)  3.b Landing Page
----
Usando toda la información que conseguimos con el moodboard diseñamos lo que será nuestra [landing page](https://github.com/Groctel/DIU21/tree/master/P3#landing-page). 

![Método UX](img/guidelines.png) 3.c Guidelines
----

Para todo el diseño de la aplicación seguimos una serie de [guías de estilo](https://github.com/Groctel/DIU21/tree/master/P3#guidelines) que se ajustasen al *Material Desing* que buscábamos.

![Método UX](img/mockup.png)  3.d Mockup
----

Para el [mockup](https://github.com/Groctel/DIU21/tree/master/P3#mockup-layout-hi-fi) usamos Figma para que pudiese tener cierto grado de interactividad.

![Método UX](img/caseStudy.png) 3.e ¿My UX-Case Study?
-----

Hemos resumido toda la información de la creación y diseño de nuestro [Case-Study](https://github.com/Groctel/DIU21/tree/master/P3#documentaci%C3%B3n-publicaci%C3%B3n-del-case-study) explicando el proceso creativo que hemos seguido.
